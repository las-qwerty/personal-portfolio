...
const Button = ({ children, className = "", variant = "default", ...props }: ButtonProps) => {
  ...
  const variants = {
    ...
    secondary: "bg-white/50 dark:bg-white backdrop-blur-sm border border-white/20 hover:bg-white/70 dark:hover:bg-white/20 px-8 py-3",
  };
...
const AnimatedButton = ({ 
  ...
  >
    <Button
      ...
      onClick={onClick}
      variant="secondary"
      className={`text-lg border relative overflow-hidden group py-6 px-6 rounded-full transition-all duration-300 bg-white text-black hover:text-white shadow-2xl ${
    ...
    >
      ...
      <span className="absolute inset-0 transition-all duration-300 ease-in-out rounded-full bg-gradient-to-r from-stone-900 to-stone-950 w-0 group-hover:w-full"></span>
    </Button>
  </motion.div>
);
...
export default function ContactForm() {
  ...
  return (
    <section id="contact" className="max-w-7xl mx-auto px-4 py-20 md:py-32 relative overflow-hidden">
      {/* Background elements */}
      ...
      >
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Ready to bring your digital vision to life? Get in touch and let&apos;s discuss how I can help you build something amazing.
        </p>
      </motion.div>
          ...
          <Card>
            <CardContent>
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                A passionate self-taught web developer with 3+ years of experience in WordPress, Shopify, and modern web technologies. I specialize in creating responsive, user-friendly websites that drive real business results.
              </p>
            ...
            <CardContent>
              {!isSubmitted ? (
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold mb-4 text-[#6F4E37]">
