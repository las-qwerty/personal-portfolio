...
const projects = [
  ...
  },
  {
    ...
    highlights: ["Custom WordPress theme", "Mobile-first approach"],
  },
];

const categories = ["All", "WordPress", "Shopify"];
      ...
      <div className="relative overflow-hidden rounded-3xl bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-xl hover:shadow-2xl transition-all duration-500 h-full flex flex-col">
        ...
        <div className="p-6 flex-1 flex flex-col">
          <div className="flex items-center justify-between mb-3">
            <Badge
              variant="secondary"
              className="text-xs flex items-center rounded-full"
            >
                    ...
                    <div className="grid gap-3">
                      {project.highlights.map(
                        (highlight: string, index: number) => (
                          <div
                            key={index}
                            className="flex items-center gap-3 p-3 rounded-lg bg-white/50 dark:bg-white/5 backdrop-blur-sm border border-white/20"
                          >
    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="text-center mt-16 p-0 md:p-8"
        >
          <h3 className="text-2xl font-bold mb-4 mt-4">3+ Years of Experience</h3>
          <p className="mb-6 text-xl text-muted-foreground max-w-3xl mx-auto">
            Self-taught web developer specializing in WordPress, Shopify, and
            modern web technologies. Focused on delivering user-friendly,
            responsive websites that drive real business results.
          </p>
