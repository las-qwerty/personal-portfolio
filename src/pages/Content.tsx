...
export default function Content() {
  ...
  return (
    <main className="flex flex-col items-center justify-center h-auto">
      <div className="flex flex-col items-center justify-center pt-20 md:pt-40 pb-20 md:pb-40">
      ...
      <section className="flex flex-col gap-12 py-4 px-4 md:px-0">
            <div className="grid w-full auto-rows-[22rem] grid-cols-3 gap-4 md:grid-cols-3 lg:grid-cols-4">
